...
### Quick Reference
- **39 skills** (30 user-invocable + 9 infrastructure) — see `install/profiles/shipkit.manifest.json`
- **9 agents** (1 orchestrator [interim: orch-direction, retires with SS-3], 5 producers, 3 reviewers) — see `install/agents/`
