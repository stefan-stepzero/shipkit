...
**Recommended:**
- `.shipkit/specs/active/[feature].md` - Spec to update (will create if missing)
...
Options:
1. Update existing spec: [list specs from .shipkit/specs/active/]
...
- Create new spec at `.shipkit/specs/active/[feature].md`
...
**Write to:** `.shipkit/specs/active/[feature].md`
...
**Show user:**
```
✅ Updated spec: .shipkit/specs/active/[feature].md
...
**Spec files (optional):**
- `.shipkit/specs/active/[feature].md` - Existing spec to update
...
**Updates (APPEND):**
- `.shipkit/specs/active/[feature].md` - Appends UI/UX section
