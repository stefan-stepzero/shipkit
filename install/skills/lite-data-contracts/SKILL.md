...
3. Save to `.shipkit-lite/types.md` and `.shipkit-lite/validation-schemas.md`
...
- `.shipkit-lite/schema.md` - Database schema (if exists)
- `.shipkit-lite/types.md` - Existing types (if exists)
- `.shipkit-lite/component-contracts.md` - Component contracts (if exists)
- `.shipkit-lite/validation-schemas.md` - Existing Zod schemas (if exists)
...
- `.shipkit-lite/types.md` - TypeScript type definitions (canonical types)
...
Suggest: "Run `/lite-user-instructions` to track migration task"
