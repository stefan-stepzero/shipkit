...
**Optional**:
- `.shipkit-lite/why.md` (Vision helps guide persona creation)
- `.shipkit-lite/stack.md` (Technical constraints inform feasibility)
...
- `.shipkit-lite/why.md` - Vision context
- `.shipkit-lite/stack.md` - Technical constraints
...
**Create file using Write tool**: `.shipkit-lite/product-discovery.md`
...
1. Create archive: `.shipkit-lite/archive/product-discovery/`
...
- `.shipkit-lite/why.md` - Understand project vision
...
**Creates/Updates**:
- `.shipkit-lite/product-discovery.md` - Combined personas, user journeys, user stories
