---
name: shipkit-teach
description: Persist learnings and corrections to CLAUDE.md (root or subfolder). Use when user says "remember this", "save this", or invokes /teach.
invoke: user
model: haiku
tools:
  - Read
...
Persist learnings to CLAUDE.md so future sessions and subagents automatically inherit them.
...
**Explicit triggers:**
- `/teach <learning>` — with inline content
- `/teach` — prompts for learning
