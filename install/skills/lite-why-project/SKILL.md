...
**Auto-suggested**: Session start if `why.md` doesn't exist (via lite-session-start.py)
...
- `/lite-spec` - Create feature specs (can reference vision for alignment)
...
**On update (if why.md exists)**: `.shipkit-lite/why.md` - Read old answers as defaults
...
**Creates/Updates**: `.shipkit-lite/why.md` - OVERWRITE AND REPLACE
