...
## Using Skills
Use skills when you need persistence (saving context to `.shipkit/`) or forcing explicit human decisions. For prototyping, iteration, and UI implementation - proceed naturally without a skill.
