...
**Creates:** `.shipkit/specs/active/user-accounts.json`
...
Start with:
- `why.json` — Takes 15 minutes, provides foundation
- `stack.json` — Auto-generated by `/shipkit-project-context`
...
1. **Start small** — `why.json` + `stack.json` is enough to begin
